## Trying different peakfinders from the web. All functions should be made compatible in terms of input type
## also try: http://pythonhosted.org/PeakUtils/
## also try: https://github.com/steinmann/pypeak/blob/master/pypeak.py
...
def duarte_findpeaks(x, mph=None, mpd=1, threshold=0, edge='rising',
...
def slavic_findpeaks(data, spacing=1, limit=None):
    """
