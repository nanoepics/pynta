...
class CameraViewerWidget(QWidget):
    ...
    def draw_target_pointer(self, locations):
        ...
        outline = pg.mkPen(color=(255, 0, 0), width=2) # width is thickness of line in "monitor-pixels"
        filling = pg.mkBrush(color=(0, 0, 0, 0))  # the 4th element is alpha, 0 = transparent
        self.marker.setData(locations[0], locations[1], symbol='s', symbolBrush=filling, symbolPen=outline,
                            symbolSize=self.parent.experiment.config['analysis']['box_half_size']*2+1, pxMode= False, alphaMode=True)
