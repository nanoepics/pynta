...
# Import trackpy to get the version string generated by versioneer
import pynta
...
project = u'pynta'
copyright = u'2018-{}, PyNTA Contributors'.format(date.today().year)
...
release = pynta.__version__
version = pynta.__version__
